...
import {
    FaHome, FaUser, FaAddressBook, FaHandshake
} from "react-icons/fa";
                ...
                <Switch>
                    <span>
                        <nav >
                            ...
                            <ul>
                                <Link to="/home"><li><a href="#"><span>{` EZInsure`}</span></a></li></Link>
                                <li><a href="#"><FaUser /></a>
                                <Button
                                    id="fade-button"
                                ...
                                <li><a href="#"><FaHandshake />{` SERVICES`}</a></li>
                                <Link to="/contactus"><li><a href="#"><FaAddressBook />{` CONTACT`}</a></li></Link>
                            </ul>
                        </nav>
                    </span>
                </Switch>
