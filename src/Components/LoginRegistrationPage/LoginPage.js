...
const LoginPage = ({setIsLogin,userDetails}) => {
  ...
  fetch("http://localhost:8083/registration/login",{
    method:"POST",
  ...
  .then((data)=>{
    if(data==0){
      ...
      history.push("/Userreq" , loginData.email)
    }
    ...
    return (
        ...
        <Container component="main" maxWidth="xs" style={{marginBottom:"100px"}}>
          ...
          >
            ...
            >
              <TextField
                margin="normal" required fullWidth id="email" label="Email Address" name="email" autoComplete="email" variant="standard"
                autoFocus />
