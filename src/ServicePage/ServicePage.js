...
const ServicePage =()=>{
  ...
  <div classNAme="card-body">
    ...
    <p className="card-text">Just starting out? Get all the startup insurance coverage your company needs.Application is easy and takes under ten minutes.</p>
    <br/><br/>
...
<div className="row">
  ...
  <div classNAme="card-body">
    ...
    <p className="card-text">A comprehensive auto insurance policy, also known as motor package insurance, saves you money when your auto is damaged in an accident or natural calamity.It also covers your vehicle against theft and burglary. At times, you may end up hurting others or damaging property in an accident.A auto insurance policy covers such third party liabilities as well.</p>
    <br/><br/>
    <a onClick={clickHandlers}  className="btn btn-danger">Get A Quote</a>
  </div>
</div>
...
<div className="card" style={{width:"500px" ,padding:"30px" , marginLeft:"300px"  , marginRight:"100px" ,marginBottom:"200px" , marginTop:"20px" ,paddingBottom:"50px"} }>
  ...
  <div classNAme="card-body">
    ...
    <p className="card-text">A comprehensive truck insurance policy, also known as motor package insurance, saves you money when your truck is damaged in an accident or natural calamity.It also covers your vehicle against theft and burglary. At times, you may end up hurting others or damaging property in an accident.A truck insurance policy covers such third party liabilities as well.</p>
    <a onClick={clickHandlers}  className="btn btn-danger">Get A Quote</a>
  </div>
  </div>
</div>
